/*=============================================================================
 ...
 |     Due Date:  01/03/2019
 |
 |  Description: This is our implementation of a simple accelerometer service
 |               that transmits data between Micro:bit to a computer with a
 |               website that uses the accelerometer data to move within a game.
 |
 *===========================================================================*/
